...
class ChromeHoppingApp(rumps.App):
    ...
    def show_about(self, _=None):
        ...
        lines = [
            ...
            "with a single click.",
            "",
            "Menu Bar - Quickly switch to any Chrome profile and bring its windows to the front.",
            "",
            "Dock Access - Create a dedicated macOS app for each Chrome profile.",
            "Simply drag the apps from ~/Applications/Chrome Profiles to your Dock",
            "for one-click profile switching.",
            "",
            "Spotlight Integration - Press ⌘ Space and type a profile name to instantly",
            "launch or switch to that Chrome profile.",
            "",
            f"Profiles detected: {len(self.profiles)}",
            f"Install location: {install_short}",
            f"Log file: {log_short}",
            "",
            "Created by Amir Tito",
